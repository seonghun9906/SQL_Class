...
-- 회원 데이터 저장
insert into member_tbl_02 values(100001, '황명훈', '010-1111-2222', '서울 동대문구 휘경1동', '20151202', 'A', '01');   
insert into member_tbl_02 values(100002, '이주헌', '010-1111-3333', '서울 동대문구 휘경2동', '20151206', 'B', '01');   
...
-- 회원 매출 데이터 저장
insert into money_tbl_02(custno, pcost, amount, price, pcode, sdate) values(100001, 500, 5, 340000000, 'A001', '20160101');    
insert into money_tbl_02(custno, pcost, amount, price, pcode, sdate) values(100001, 1000, 4, 0, 'A002', '20160101');    
insert into money_tbl_02(custno, pcost, amount, price, pcode, sdate) values(100001, 500, 3, 0, 'A008', '20160101');    
insert into money_tbl_02(custno, pcost, amount, price, pcode, sdate) values(100002, 2000, 1, -480000000, 'A004', '20160102');    
insert into money_tbl_02(custno, pcost, amount, price, pcode, sdate) values(100002, 500, 1, 0, 'A001', '20160103');    
